...
import { colorsOfCat } from '../../components/CatzImages';
...
export default function Home() {
  ...
  const [color, setColor] = useState("/catz/colors-of-cat/colors-of-cat-1.png");
  ...
  return (
    <div className={styles.container}>
       <main className={styles.main}>
        ...
        <div 
          onClick={ () => setColor(randomElement(colorsOfCat)) } 
          style={{
            fontSize: "1em",
            borderRadius: "10px",
            color: "white",
        ...
        <div>
          ...
          {/* <RandomCatImage /> */}
          <img src={color} width="500px" />
          <img src="/catz/face-markings/face-stripes-1.png" width="500px" />
          <img src={color} width="500px" />
          <img src={color} width="500px" />
        </div>
      </main>
